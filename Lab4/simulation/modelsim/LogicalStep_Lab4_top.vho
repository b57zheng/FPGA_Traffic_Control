...
-- Equation(s):
-- \INST8|hreg~0_combout\ = (\pb_n[3]~input_o\ & (\pb_n[2]~input_o\ & ((\INST8|hreg~q\) # (\INST6|sreg\(1)))))
...
-- Equation(s):
-- \INST7|hreg~0_combout\ = (\pb_n[3]~input_o\ & (\pb_n[2]~input_o\ & ((\INST7|hreg~q\) # (\INST5|sreg\(1)))))
...
-- Equation(s):
-- \INST1|clk_proc:COUNT[1]~1_combout\ = (\INST1|clk_proc:COUNT[0]~q\ & (\INST1|clk_proc:COUNT[1]~q\ $ (VCC))) # (!\INST1|clk_proc:COUNT[0]~q\ & (\INST1|clk_proc:COUNT[1]~q\ & VCC))
-- \INST1|clk_proc:COUNT[1]~2\ = CARRY((\INST1|clk_proc:COUNT[0]~q\ & \INST1|clk_proc:COUNT[1]~q\))
...
PORT MAP (
	...
	datab => \INST1|clk_proc:COUNT[1]~q\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	datab => \INST1|clk_proc:COUNT[9]~q\,
	datad => VCC,
